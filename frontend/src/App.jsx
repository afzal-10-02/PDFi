...
function JPGtoPDFConverter() {
  ...
  return (
    <div className="container py-3 min-vh-100 d-flex flex-column align-items-center"
      style={{
        maxWidth: "75%"
      }}
    >
      ...
      <div
        ...
        style={{
          minHeight: "200px",
          display: imageFiles.length === 0 ? "none" : "flex",
          marginRight: window.innerWidth <= 576 ? "10px" : "0px",
        }}
      >
